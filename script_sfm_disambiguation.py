...
def get_args():
    ...
    # Resume:
    parser.add_argument('--pretrained', default='/content/doppelgangers/weights/doppelgangers_classifier_loftr.pt', type=str,
...
def colmap_runner(args):
    if args.matching_type == 'vocab_tree_matcher':
        ...
        vocab_tree_path = '/content/doppelgangers/weights/vocab_tree_flickr100K_words1M.bin'
        if not os.path.exists(vocab_tree_path):
            os.system('wget https://demuc.de/colmap/vocab_tree_flickr100K_words1M.bin')
            os.system('mv vocab_tree_flickr100K_words1M.bin /content/doppelgangers/weights/')
